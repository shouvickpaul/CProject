...
int main()
{
	...
	do
	{
		...
		cout<<"\n\n\t03. *W*ITHDRAW AMOUNT";
		cout<<"\n\n\t04. *B*ALANCE ENQUIRY";
		cout<<"\n\n\t05. ALL ACCOUNT HOLDER *L*IST";
		cout<<"\n\n\t06. *C*LOSE AN ACCOUNT";
		cout<<"\n\n\t07. *M*ODIFY AN ACCOUNT";
		cout<<"\n\n\t08. *E*XIT";
		cout<<"\n\n\tSelect Your Option (1-8) \n\t[ Enter the character quoted by * from the list \n\teg. for *D*eposite enter d ]:\n\t";
		cin>>ch;
		clrscr();
		switch(ch)
		{
...
void intro()
{
	...
	cout<<"\n\n\tMANAGEMENT";
	cout<<"\n\n\t  SYSTEM";
	cout<<"\n\n\n\nDeveloped BY : Shouvick Paul";
	cout<<"\n\nCollege : Narasinha Dutt College, Howrah, West Bengal,India";
	getch();
}
void welcom()
{
